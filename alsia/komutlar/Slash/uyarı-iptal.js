...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("uyarı-iptal")
    .setDescription("Bir oyuncunun uyarısını silmenize işe yarar.")
...
if (!CezaVarmı) return interaction.reply({ embeds: [Warn.setDescription(`<a:unlemsel:1327600285597569066> ・ ***Uyarı:*** *Oyuncunun zaten uyarısı cezası yok.*`)] , ephemeral: true  })



                      const embed = new EmbedBuilder()
                      .setDescription(`<a:5961darkbluetea:1327585257578561548> ・ ${Oyuncu} *İsimli oyuncunun süre gelen uyarıları iptal edilmiştir.*
...
await guild.channels.cache.get(ayarlar.KomutLOG.uyarıLOG).send({  embeds: [embed] })
